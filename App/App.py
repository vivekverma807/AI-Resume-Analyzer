# Developed by Vivek Kumar Verma [https://github.com/vivekverma807]    Made with Streamlit
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/vivekverma807" style="text-decoration: none; color: #021659;">Vivek Kumar Verma</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/vivekverma807" style="text-decoration: none; color: grey;">Vivek Kumar Verma</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin':
                ...
                st.success("Welcome Vivek ! Total %d " % values + " User's Have Used Our Tool : )")                
